      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h1 className="text-5xl md:text-7xl font-bold mb-8 glow-text">
            Let's <span className="gradient-purple bg-clip-text text-transparent">Connect</span>
          </h1>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-3xl md:text-5xl font-bold mb-6 glow-text">
            Ready to <span className="gradient-purple bg-clip-text text-transparent">Start?</span>
          </h2>
