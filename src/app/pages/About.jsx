...
const experiences = [
  ...
  },
  {
    ...
    period: "2021 - 2022",
    description:
      "Built and maintained company websites, implemented interactive features, and optimized performance across multiple projects.",
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-gray-300 leading-relaxed max-w-3xl mx-auto">
            Passionate frontend developer with a keen eye for design and
            performance. I transform ideas into beautiful, functional web
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              { icon: Zap, number: "15+", label: "Technologies" },
