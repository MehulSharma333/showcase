    ...
    <div className="relative">
      ...
      <section className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-400/10 rounded-full blur-3xl animate-pulse-glow" style={{animationDelay: '1s'}} />
        </div>

        <div className="max-w-4xl mx-auto text-center relative z-10 bg-red-400">
          <div className="mb-8 animate-float">
            <Code className="w-20 h-20 mx-auto text-purple-400 glow-purple" />
          </div>

          <h1 className="text-5xl md:text-7xl font-bold mb-6 glow-text">
            Hi, I'm <span className="gradient-purple bg-clip-text text-transparent">Alex</span>
          </h1>
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="text-purple-400"> 2+ years</span> of expertise in modern frontend technologies
          </p>
      ...
      <section className="py-20 px-4 relative">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-16 glow-text">
            <span className="gradient-purple bg-clip-text text-transparent">Tech Stack</span>
          </h2>
